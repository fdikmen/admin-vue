    ...
    <div class="card-header py-3">
      <div class="card-title align-items-start flex-column">
        ...
        <span class="text-muted font-weight-bold font-size-sm mt-1"
          >Kullanıcı Bilgilerinizi buradan değiştirebilirsiniz</span
        >
      </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-xl-6">
            <h5 class="font-weight-bold mb-6">Kullanıcı:</h5>
          </div>
        </div>-->
        <!--begin::Form Group-->
        ...
        <!--begin::Form Group
        <div class="form-group row">
          <label class="col-xl-3 col-lg-3 col-form-label">Dil</label>
          <div class="col-lg-9 col-xl-6">
            <select
              class="form-control form-control-lg form-control-solid"
              ref="language"
        ...
        <!--begin::Form Group
        <div class="form-group row">
          <label class="col-xl-3 col-lg-3 col-form-label">Zaman Dilimi</label>
          <div class="col-lg-9 col-xl-6">
            <select
              class="form-control form-control-lg form-control-solid"
              ref="time_zone"
        ...
        <div class="form-group row align-items-center">
          <label class="col-xl-3 col-lg-3 col-form-label">İletişim Tercihi</label>
          <div class="col-lg-9 col-xl-6">
        ...
        <!--<div class="row">
          <label class="col-xl-3"></label>
          <div class="col-lg-9 col-xl-6">
            <h5 class="font-weight-bold mb-6">Güvenlik:</h5>
          </div>
        </div>
        begin::Form Group
        <div class="form-group row">
