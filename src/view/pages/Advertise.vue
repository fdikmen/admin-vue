...
<!--              <form class="form" id="advertise_form" @submit.stop.prevent="advertiseRegister($event)">-->
                ...
                <div class="form-group mb-2">
                  <input required class="form-control h-auto py-3 px-3 rounded-sm mb-2" type="text" placeholder="Başlık" name="title" ref="itemTitle" autocomplete="off" />
                </div>
                <div class="form-group mb-2">
                  <ckeditor :editor="editor" v-model="description" :config="editorConfig"></ckeditor>
  <!--                <b-form-textarea required id="textarea-lg" size="lg" placeholder="Açıklama" v-model="description" name="description"></b-form-textarea>-->
                </div>
                <h5 class="font-weight-bolder text-dark font-size-h4 my-6">
                  Reklamın Gösterileceği alan
                </h5>
                <div class="form-group mb-3 ml-3">
                  <div class="checkbox-list">
                    <label class="checkbox">
                      <input type="checkbox" ref="onTop"/>
                      <span></span> Sitenin Üst Kısmında
                    </label>
                  </div>
                </div>
                <div class="form-group mb-3 ml-3">
