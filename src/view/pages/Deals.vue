    ...
    <div class="card card-custom">
      <div class="card-header flex-wrap py-5">
        ...
        <div class="card-toolbar">
          ...
          <!--end::Dropdown-->
          <!--begin::Button-->
          <a href="javascript:;" v-b-modal.modal-1 class="btn btn-primary">
            <span class="svg-icon svg-icon-sm">
          ...
          <div>
            <b-modal id="modal-1" hide-footer>
              <div class="login-form login-signup">
                <form class="form" id="item_add_form" @submit.stop.prevent="addNewItem()">
                  ...
                  <div class="form-group row">
                    <div class="col-12 text-center">
                      <div
                        class="image-input image-input-outline text-center"
                      ...
                      <span class="form-text text-muted"
                        >Yüklenebilecek resim türleri: png, jpg, jpeg.</span
                      >
                    </div>
                  </div>
                  <div class="form-group mb-2">
                    <input
                      required
                      class="form-control h-auto py-3 px-3 rounded-sm mb-2"
                      type="text"
                      placeholder="Başlık"
                      name="title"
                      ref="itemTitle"
                  ...
                  <div class="form-group mb-2">
                    <ckeditor :editor="editor" v-model="fullDescription" :config="editorConfig" tag-name="textarea"></ckeditor>
<!--                    <b-form-textarea-->
<!--                      required-->
<!--                      id="textarea-lg"-->
<!--                      size="lg"-->
              ...
              <tr v-for="item in getAllItems" :key="item.id">
                ...
                <td>
                  <span class="switch switch-sm">
                      <label>
                        <input type="checkbox" :checked="item.isActive" name="email_notification_1" @change="changeStatus(item)" />
                        <span class="mr-2"></span>
                      </label>
                    </span>
                  <span v-if="item.isActive">Aktif</span>
...
<!--                    </a>-->
                    <a
                      ...
                      title="Delete"
                      v-b-tooltip.hover.top="'Fırsatı Sil'"
    ...
    <div class="d-flex align-center justify-content-between">
      <div class="d-flex align-center justify-content-between">
        ...
        <p class="align-self-center mb-0 ml-4">Toplam <strong>{{ currentItems }}</strong> fırsat</p>
      </div>
